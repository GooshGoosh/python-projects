'''
high_low_impossible.py - Selects a random number from 1 to 1,000,000 and asks
the user to guess the selected number. Gives hints to the user if they are too
high or too low with their guessed number.
'''
